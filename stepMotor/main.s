...
main:
	bl uart_init
	bl init_dpad
	bl init_stepper_motor

	//Constant variable delay time=#500000
	ldr r7, =500000

dongu:
	push {r7}
//STEP 0 c11 is 1; c10 is 0; b11 is 0; b10 is 1
	//for c11 is 1
...
//STEP 1 c11 is 0; c10 is 1; b11 is 0; b10 is 1
	//for c11 is 0
	mov r0,#2
	mov r1,0x00000800
	mov r2,#0
...
//STEP 2 c11 is 0; c10 is 1; b11 is 1; b10 is 0
	//for c11 is 0
	push {r7}
	mov r0,#2
	mov r1,0x00000800
...
//STEP 3 c11 is 1; c10 is 0; b11 is 1; b10 is 0
	//for c11 is 1
